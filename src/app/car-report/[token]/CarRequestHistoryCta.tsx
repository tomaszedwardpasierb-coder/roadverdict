// Place at: src/app/car-report/[token]/CarRequestHistoryCta.tsx
// Car mirror of report/[token]/RequestHistoryCta.tsx.
'use client';
...
export function CarRequestHistoryCta({ registration, signedInEmail, currentPath }: Props) {
    ...
    return (
      <div className={styles.upcomingBlock}>
        ...
        <p className={styles.upcomingNote}>
          If the current owner approves it, this car&apos;s history moves to your account, and you&apos;ll get an
          email either way.
        </p>
      </div>
    );
  ...
  return (
    <div className={styles.upcomingBlock}>
      <p className={styles.upcomingTitle}>Bought this car? Keep its history alive.</p>
      <p className={styles.upcomingNote}>
        Everything above is real, logged history - not guesswork. If you&apos;ve bought this car, you can carry
        that same record forward under your own free RoadVerdict account, instead of starting from a blank page.
        It&apos;s what will make your eventual buyer trust this car too, the same way you just did.
      </p>
      {signedInEmail ? (

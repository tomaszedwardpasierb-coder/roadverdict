  ...
  return (
    <div className="verdict-wrap">
      ...
      <div className="insurance-cta">
        ...
        <a href="https://www.google.com/search?q=motorcycle+pre-purchase+inspection+UK" target="_blank" rel="noopener noreferrer" className="btn-primary insurance-cta__link">

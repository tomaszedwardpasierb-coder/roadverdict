  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden focusable="false">
      <g className={styles.wheel}>
        <circle cx="12" cy="12" r="9.5" stroke="var(--asphalt)" strokeWidth="1.6" />
        {/* Wire spokes */}
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden focusable="false">
      ...
      <g className={`${styles.wheel} ${styles.wheelCar}`}>
        ...
        <circle cx="12" cy="12" r="7.6" stroke="var(--asphalt-2)" strokeWidth="0.8" />
        {/* 5-spoke alloy pattern - solid wedges, not wire spokes */}
...
export function VehicleSpinner({ kind = 'bike', size = 18, label = 'Loading', decorative = true, className }: Props) {

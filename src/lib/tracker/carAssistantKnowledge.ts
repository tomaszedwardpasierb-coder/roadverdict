...
- **Insights** - Reports, The Story So Far, and The Vault. The "how's my car doing, and what's its
...
### 6.13a The Vault
**What:** A private, extra-secured place to store scanned copies of your car's actual paperwork
...
police stop, a DVLA query, or selling the car - are exactly the ones most likely to be a photo
...
**Limits:** Up to 20 documents per car, 10MB per file, 100MB total per car. PDF, JPEG, and PNG
only.
